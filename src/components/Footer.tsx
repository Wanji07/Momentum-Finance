...
export default function Footer() {
    ...
    return (
        <footer className="fixed bottom-0 w-full mx-auto mt-3 rounded-t-lg border border-white/5 bg-[#161B22]/90 px-4 py-3 text-center text-xs text-white/45 backdrop-blur-sm">
